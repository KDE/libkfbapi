...
#ifndef KFBAPI_USERINFOJOB_H
#define KFBAPI_USERINFOJOB_H
 ...
 */
class LIBKFBAPI_EXPORT UserInfoJob : public FacebookGetJob
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit UserInfoJob(const QString &accessToken, QObject *parent = 0);
